...
class MyTableViewController: UITableViewController {
    ...
    var foodStores:[FoodStore] = [
        ...
        FoodStore(name: "영남관", image: "07", address: "부산광역시 부산진구 양정동 418-61", tel: "051-865-0032", menu: "짬뽕, 짜장면, 짬뽕밥, 볶음밥, 탕수육, 군만두", type: "중화요리"),
        ...
        FoodStore(name: "개미식당", image: "10", address: "부산광역시 부산진구 범천1동 850-173", tel: "051-868-8020", menu: "참치찌개, 순두부, 된장찌개, 김치찌개, 시락국, 두루치기정식, 비빔밥", type: "한식"),
