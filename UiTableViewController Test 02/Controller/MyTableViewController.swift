...
class MyTableViewController: UITableViewController {
    ...
    var foodStores:[FoodStore] = [
        ...
        FoodStore(name: "영남관", image: "07", address: "부산광역시 부산진구 양지로 36", tel: "051-865-0032", menu: "짬뽕, 짜장면, 짬뽕밥, 볶음밥, 탕수육, 군만두", type: "중화요리"),
        
        FoodStore(name: "명동불백", image: "08", address: "부산광역시 부산진구 양지로 37-1", tel: "051-867-8581", menu: "명동불백, 고추장불백, 김치덮밥, 양파돈까스덮밥, 양파탕수육덮밥", type: "한식"),
        FoodStore(name: "미쳐버린파닭", image: "09", address: "부산광역시 부산진구 양정동 350-61", tel: "051-851-2688", menu: "순살후라이드+양념치킨+콜라+쿠폰, 순살후라이드+간장치킨+콜라+쿠폰, 순살양념치킨+양념치킨+콜라+쿠폰,", type: "치킨집"),
